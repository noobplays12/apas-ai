...
import { Users, UserPlus, Search, Filter, MoreHorizontal, Loader2, DatabaseBackup } from 'lucide-react';
...
export default function TeacherManagement({ user }: TeacherManagementProps) {
        ...
        <table className="w-full text-left">
          <thead>
            <tr className="border-b border-gray-50 bg-gray-50/50">
              <th className="px-8 py-6 text-[10px] font-black uppercase tracking-widest text-gray-400">Faculty ID</th>
          ...
          <tbody>
            {teachers.length === 0 ? (
              ...
              teachers.map((teacher) => {
                ...
                return (
                <tr key={teacher.id} className="border-b border-gray-50 transition-all hover:bg-gray-50/50">
                  <td className="px-8 py-6 text-sm font-black text-gray-900">{teacher.id.substring(0, 8)}...</td>
                  <td className="px-8 py-6 text-sm font-bold text-gray-900">{teacher.name}</td>
                  <td className="px-8 py-6 text-sm font-bold text-gray-400">{teacher.email}</td>
                  <td className="px-8 py-6 text-sm font-black text-[#003399]">{teacher.department || 'General'}</td>
